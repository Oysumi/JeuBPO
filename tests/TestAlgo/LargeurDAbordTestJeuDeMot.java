...
class LargeurDAbordTestJeuDeMot {
    ...
    void testRechercheVrai(){
        ...
        try{
            ...
            flotFiltreDeux.println("LARGEUR D'ABORD VRAI (ABOT) : " + estimatedTime +"ns.");
        ...
        try{
            ...
            BufferedWriter flotFiltreUn = new BufferedWriter(flot);
            PrintWriter flotFiltreDeux = new PrintWriter(flotFiltreUn);
            flotFiltreDeux.println("LARGEUR D'ABORD VRAI (IXAT) : " + estimatedTime +"ns.");
            flotFiltreDeux.close();
        } catch (IOException e) {
            System.out.println("Impossible d'écrire les résultats des tests.");
            System.exit(3);
    ...
    void testRechercheFaux(){
        ...
        try{
            ...
            BufferedWriter flotFiltreUn = new BufferedWriter(flot);
            PrintWriter flotFiltreDeux = new PrintWriter(flotFiltreUn);
            flotFiltreDeux.println("LARGEUR D'ABORD FAUX (JABO) : " + estimatedTime + "ns.");
            flotFiltreDeux.close();
        } catch (IOException e) {
            System.out.println("Impossible d'écrire les résultats des tests.");
            System.exit(3);
        ...
        try{
            ...
            BufferedWriter flotFiltreUn = new BufferedWriter(flot);
            PrintWriter flotFiltreDeux = new PrintWriter(flotFiltreUn);
            flotFiltreDeux.println("LARGEUR D'ABORD FAUX (KAMO) : " + estimatedTime + "ns.");
            flotFiltreDeux.close();
        } catch (IOException e) {
            System.out.println("Impossible d'écrire les résultats des tests.");
            System.exit(3);
